 ...
 * @property \Carbon\Carbon|null $created_at
 * @property \Carbon\Carbon|null $updated_at
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Account whereAccountNumber($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Account whereAgency($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Account whereBalance($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Account whereBalanceInitial($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Account whereBankId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Account whereBankImage($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Account whereTitle($value)
 ...
 * @property \Carbon\Carbon|null $created_at
 * @property \Carbon\Carbon|null $updated_at
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Bank whereCode($value)
